...
for i in $(seq 1 $COUNT); do
    ...
    SAM_API_TOKEN="secret-token" sam-box run -u "$UDS_PATH" --data-dir "/tmp/sam-box-$VM_ID" --control-plane "https://bananas.sam-mesh.dev" --log-level debug > /var/log/sam-box-$VM_ID.log 2>&1 &
